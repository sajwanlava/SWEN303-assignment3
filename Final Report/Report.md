...
What we could have improved in was our prototype does not take a user input in. Therefore, we can not anticipate whether users will actually like how the prototype processes it. Due to the lack of this user input, we cannot test adding a calendar or room booking either. While we were prompt in implementing the user feedback changes, we did not user test our final prototype again. While this was not a necessity to do well in this project, we feel as though it would have bettered our prototype overall as it would give us a conclusive answer as to whether or not our prototype was the best it could be. 
