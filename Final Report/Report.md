...
**Erin's Assignment 2 Prototype**
![Erin's Assignment 2 Prototype](Final%20Report/Background/Yijuan_Jin.png)
## DESIGN REVIEW
...
| ------ | ------ | ------ | ------ | ------ |
| Callum | Easy to find a new group and check a group already have about the specific course. And get the booked events reminder |Some pages looks too crowded |Makes Calender smaller and changes the font-size| Remove booking, Group Finder page, Change timeslot of booking,booked events reminder |
| Jaimar | There are very specific ways for finding a room | Too many options to find rooms,and some pages looks not clean | Remove some options of finding rooms | Group project management |
...
| Alesha | Room booking button just under each course page, not need to go to seperate page to book rooms.| | Need more colours | Upload file, Download file |
...
In the final prototype, another thing we left out was when the chats were expanded to become full-screen chat interface; it was unable to shrink down from the full page back to the pop-up. This was more to do with an Adobe XD feature, as it does not let overlays go back to their last state; instead, it resets the page completely.
...
We did not implement showing scroll bars on the prototype as that issue was rated a low severity and in actuality, many users use laptops which do not even show a scroll bar anymore; namely Apple Macs. Another low severity issue we did not fix was the group chat to be of higher precedence than the other chats as one of our testers suggested. This was because we decided that it would be more intuitive for messages to be listed in chronological order. 
